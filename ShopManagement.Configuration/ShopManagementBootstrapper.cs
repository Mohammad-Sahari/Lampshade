...
namespace ShopManagement.Configuration
{
    public class ShopManagementBootstrapper
    {
        public static void Configure(IServiceCollection services, string connectionString)
        {
            ...
            // Registering Order services in DI container
            services.AddTransient<IOrderRepository,OrderRepository>();
            services.AddTransient<Application.Contracts.Order.IOrderApplication,OrderApplication>();

            // Registering Cart services in DI container
            services.AddSingleton<ICartService, CartService>();

            // Registering InventoryAcl services in DI container
